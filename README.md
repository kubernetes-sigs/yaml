...
A wrapper around [go-yaml](https://github.com/yaml/go-yaml) designed to enable a better way of handling YAML when marshaling to and from structs.
...
This package uses [go-yaml](https://github.com/yaml/go-yaml) and therefore supports [everything go-yaml supports](https://github.com/yaml/go-yaml#compatibility).
